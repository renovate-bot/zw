...
#### Without using [Turbo mode](/docs/getting_started/overview#turbo-mode-zsh--53) and without the [`for`](/docs/guides/syntax#the-for-syntax) syntax {#without-using-turbo-mode-and-without-the-for-syntax}
