...
import APITable from '@site/src/components/APITable'; import Image from '@theme/IdealImage'; import Screen1 from '@site/static/img/zui/hello-world-fs8.png'; import Screen2 from '@site/static/img/zui/zui-text-fields-fs8.png'; import Screen3 from '@site/static/img/zui/zui-list-boxes-fs8.png'; import Screen4 from '@site/static/img/zui/zui-history-fs8.png'; import Screen5 from '@site/static/img/zui/zui-edit-fs8.png';

### CGI+DHTML-like User Interface Library for Zsh / ZCurses

Repository: [ZUI][1] , issues reports: [z-shell/zui][2]
